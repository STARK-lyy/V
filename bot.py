...
class SnowCloudBot(commands.Bot):
    ...
    async def status_rotation(self):
        ...
        # Check if bot is ready and connected to Discord
    ...
    async def close(self):
        if hasattr(self, 'status_rotation') and self.status_rotation.is_running():
...
async def on_ready():
    ...
    try:
        ...
        # Start status rotation after everything is ready
        await asyncio.sleep(2)  # Small delay to ensure everything is connected
        if not bot.status_rotation.is_running():
            bot.status_rotation.start()
...
async def vps_stats(ctx, vps_id: str):
    ...
    try:
        ...
        try:
            ...
            embed = create_embed(f"Resource Usage for VPS {vps_id}")
...
async def change_ssh_password(ctx, vps_id: str):
    ...
    try:
        ...
        try:
            ...
            embed = create_embed(f"SSH Password Updated for VPS {vps_id}", color=discord.Color.green())
...
async def admin_stats(ctx):
    ...
    try:
        ...
        embed = create_embed("SnowCloud System Statistics")
...
"""
        ...
        embed = create_embed("Detailed System Information")
...
async def vps_usage(ctx):
    ...
    try:
        ...
        embed = create_embed("Your SnowCloud VPS Usage")
...
async def global_stats(ctx):
    ...
    try:
        ...
        embed = create_embed("SnowCloud Global Usage Statistics")
...
async def list_banned(ctx):
    ...
    embed = create_embed("Banned Users", color=discord.Color.red())
    banned_list = []
...
class VPSManagementView(ui.View):
    ...
    async def handle_missing_container(self, interaction: discord.Interaction):
        ...
        embed = create_embed(f"SnowCloud VPS Management - {self.vps_id}", color=discord.Color.red())
    ...
    async def start_vps(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            embed = create_embed(f"SnowCloud VPS Management - {self.vps_id}", color=discord.Color.green())
    ...
    async def stop_vps(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            embed = create_embed(f"SnowCloud VPS Management - {self.vps_id}", color=discord.Color.orange())
            ...
            if token:
                ...
                try:
                    ...
                    if ssh_session_line:
                        ...
                        try:
                            owner = await bot.fetch_user(int(vps["created_by"]))
                            embed = create_embed(f"SnowCloud VPS Restarted - {self.vps_id}", color=discord.Color.blue())
        ...
        try:
            ...
            try:
                ...
                if ssh_session_line:
                    ...
                    try:
                        owner = await bot.fetch_user(int(vps["created_by"]))
                        embed = create_embed(f"SnowCloud VPS Reinstalled - {self.vps_id}", color=discord.Color.blue())
...
class TransferVPSModal(ui.Modal, title='Transfer VPS'):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            try:
                embed = create_embed("SnowCloud VPS Transferred to You", color=discord.Color.green())
...
async def manage_vps(ctx, vps_id: str):
    ...
    try:
        ...
        embed = create_embed(f"SnowCloud VPS Management - {vps_id}")
